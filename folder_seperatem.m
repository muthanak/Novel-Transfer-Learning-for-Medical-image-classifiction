...
% num = xlsread('ISIC_2020_Training_GroundTruth_new');

% %k=2;
% for n=1:length(num)      %379
%             u_train = readimage(imds_train,n);
%                   %imshow(u_train);
% if (num(n)==0)
% %    
% %           name = imds_train.Files(n);
% %           name = name{1};
% % 
% % %           name2 = name(100:length(name));
% %             name2 = name(28:length(name));
% %             name3 = ['C:\Users\zain\Desktop\result0\' name2];
%          
%            FileName = sprintf('F:\\matlab\\skin datasert\\matlab\\result0\\%d.jpg', n);
...
% %           name = name{1};        
% % %           name2 = name(100:length(name));
% %           name2 = name(21:length(name));
% % 
% %           name3 = ['C:\Users\zain\Desktop\result1\' name2];
%          
%             FileName = sprintf('F:\\matlab\\skin datasert\\matlab\\result1\\%d.jpg', n);
%             imwrite(u_train,FileName);
%     
% end
% end
...
% 				drawnow;
        ...
        FileName = sprintf('F:\\matlab\\skin datasert\\matlab\\h\\%d.jpg', n+600);
